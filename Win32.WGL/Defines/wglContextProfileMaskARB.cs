...
{
	/// <summary>
	/// Values of <see cref="wglContextAttributeARB.CONTEXT_PROFILE_MASK_ARB"/> at <see cref="wgl.CreateContextAttribsARB(HDC, HGLRC, int[])">wgl.CreateContextAttribsARB</see>.
	/// </summary>
